...
class Agent:
    ...
    def __init__(self, dimen, q_matrix, agent_position, env, eligibility=[],
                 discounted_future_reward=0.0, reward=0.0, alpha=0.5, gamma=0.8, lamb=0.95, epsilon=0.5,
